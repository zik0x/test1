...
class PetFriends:
    ...
    # @log
    def get_list_of_pets(self, auth_key, content_type='application/json', filter=''):
        '''Get /api/pets метод получения списка вcех питомцев'''
...
# print(status)
# print(result)
# status, result= p.get_list_of_pets(key, content_type='application/xml', filter='my_pets')
# print(status)
# print(result)
# print(headers)
